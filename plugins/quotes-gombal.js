...
const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: 'QUOTES GOMBAL', 
    orderTitle: gcname,
    thumbnail: 'https://telegra.ph/file/c080917609684bf229cd3.jpg', 
    sellerJid: '0@s.whatsapp.net' 
    }
    }
    }
conn.sendBut(m.chat, anu, "📮 Mau lagi? Klik Button dibawah ini", 'Quotes Gombal', '.gombal', fliveLoc) 
}
handler.help = ['gombal']
handler.tags = ['quotes']
